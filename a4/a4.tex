...
\begin{enumerate}[label=(\roman*)]
    ...
    \item We can relate the velocity dispersion to the width of the emission line using the following equation:
        ...
        \end{align*}
        Rearranging for $\Delta v$ and plugging in the appropriate values, we find that $\Delta v$ is 
        \begin{align*}
            \Delta v = \frac{\Delta \lambda}{\lambda}\times c = \frac{0.025~{\rm \mu\,m}}{4~{\rm \mu\,m}}\times 2.99\times 10^{8}~{\rm m\,s^{-1}} = 1.87\times 10^{6}~{\rm m\,s^{-1}}.
        \end{align*}
